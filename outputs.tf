output "linux_web_app_slots_id" {
  description = "Map of id values across all linux_web_app_slots, keyed the same as var.linux_web_app_slots"
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.id if v.id != null && length(v.id) > 0 }
}
output "linux_web_app_slots_app_metadata" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.app_metadata if v.app_metadata != null && length(v.app_metadata) > 0 }
}
output "linux_web_app_slots_app_service_id" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.app_service_id if v.app_service_id != null && length(v.app_service_id) > 0 }
}
output "linux_web_app_slots_app_settings" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.app_settings if v.app_settings != null && length(v.app_settings) > 0 }
}
...
output "linux_web_app_slots_client_affinity_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.client_affinity_enabled if v.client_affinity_enabled != null }
}
output "linux_web_app_slots_client_certificate_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.client_certificate_enabled if v.client_certificate_enabled != null }
}
output "linux_web_app_slots_client_certificate_exclusion_paths" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.client_certificate_exclusion_paths if v.client_certificate_exclusion_paths != null && length(v.client_certificate_exclusion_paths) > 0 }
}
output "linux_web_app_slots_client_certificate_mode" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.client_certificate_mode if v.client_certificate_mode != null && length(v.client_certificate_mode) > 0 }
}
output "linux_web_app_slots_connection_string" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.connection_string if v.connection_string != null && length(v.connection_string) > 0 }
  sensitive   = true
}
output "linux_web_app_slots_custom_domain_verification_id" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.custom_domain_verification_id if v.custom_domain_verification_id != null && length(v.custom_domain_verification_id) > 0 }
  sensitive   = true
}
output "linux_web_app_slots_default_hostname" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.default_hostname if v.default_hostname != null && length(v.default_hostname) > 0 }
}
output "linux_web_app_slots_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.enabled if v.enabled != null }
}
output "linux_web_app_slots_ftp_publish_basic_authentication_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.ftp_publish_basic_authentication_enabled if v.ftp_publish_basic_authentication_enabled != null }
}
output "linux_web_app_slots_hosting_environment_id" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.hosting_environment_id if v.hosting_environment_id != null && length(v.hosting_environment_id) > 0 }
}
output "linux_web_app_slots_https_only" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.https_only if v.https_only != null }
}
...
output "linux_web_app_slots_key_vault_reference_identity_id" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.key_vault_reference_identity_id if v.key_vault_reference_identity_id != null && length(v.key_vault_reference_identity_id) > 0 }
}
output "linux_web_app_slots_kind" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.kind if v.kind != null && length(v.kind) > 0 }
}
...
output "linux_web_app_slots_name" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.name if v.name != null && length(v.name) > 0 }
}
output "linux_web_app_slots_outbound_ip_address_list" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.outbound_ip_address_list if v.outbound_ip_address_list != null && length(v.outbound_ip_address_list) > 0 }
}
output "linux_web_app_slots_outbound_ip_addresses" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.outbound_ip_addresses if v.outbound_ip_addresses != null && length(v.outbound_ip_addresses) > 0 }
}
output "linux_web_app_slots_possible_outbound_ip_address_list" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.possible_outbound_ip_address_list if v.possible_outbound_ip_address_list != null && length(v.possible_outbound_ip_address_list) > 0 }
}
output "linux_web_app_slots_possible_outbound_ip_addresses" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.possible_outbound_ip_addresses if v.possible_outbound_ip_addresses != null && length(v.possible_outbound_ip_addresses) > 0 }
}
output "linux_web_app_slots_public_network_access_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.public_network_access_enabled if v.public_network_access_enabled != null }
}
output "linux_web_app_slots_service_plan_id" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.service_plan_id if v.service_plan_id != null && length(v.service_plan_id) > 0 }
}
...
output "linux_web_app_slots_site_credential" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.site_credential if v.site_credential != null && length(v.site_credential) > 0 }
  sensitive   = true
}
output "linux_web_app_slots_storage_account" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.storage_account if v.storage_account != null && length(v.storage_account) > 0 }
  sensitive   = true
}
output "linux_web_app_slots_tags" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
output "linux_web_app_slots_virtual_network_backup_restore_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.virtual_network_backup_restore_enabled if v.virtual_network_backup_restore_enabled != null }
}
output "linux_web_app_slots_virtual_network_subnet_id" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.virtual_network_subnet_id if v.virtual_network_subnet_id != null && length(v.virtual_network_subnet_id) > 0 }
}
output "linux_web_app_slots_vnet_image_pull_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.vnet_image_pull_enabled if v.vnet_image_pull_enabled != null }
}
output "linux_web_app_slots_webdeploy_publish_basic_authentication_enabled" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.webdeploy_publish_basic_authentication_enabled if v.webdeploy_publish_basic_authentication_enabled != null }
}
output "linux_web_app_slots_zip_deploy_file" {
  ...
  value       = { for k, v in azurerm_linux_web_app_slot.linux_web_app_slots : k => v.zip_deploy_file if v.zip_deploy_file != null && length(v.zip_deploy_file) > 0 }
}
